...
# BART Import Script for Go ICQ
# This script imports BART (Buddy ART) asset files into Go ICQ
...
usage() {
    ...
    echo ""
    echo "Import BART assets into Go ICQ"
    echo ""
    echo "Arguments:"
...
main() {
    log_info "BART Import Script for Go ICQ"
    log_info "========================================"
