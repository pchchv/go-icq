...
var (
	...
	subGroupName = map[uint16]map[uint16]string{
		OService: {
...
// SubGroupName gets the string name of a subgroup within a food group.
// It returns "unknown" if the subgroup doesn't exist.
